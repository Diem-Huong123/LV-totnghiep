...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf(csrf -> csrf.disable()) // Nếu không dùng giao diện, có thể tắt CSRF
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/signup", "/auth/login", "/auth/verify", "/auth/upload", "/auth/accounts", "/auth/accounts/**",
                                "/auth/logout", "/auth/refreshtoken", "/auth/active", "/auth/history").permitAll()
...
//    }
    ...
    //Cấu hình CORS cho phép gọi API từ React
//    @Bean
//    public CorsConfigurationSource corsConfigurationSource() {
//        CorsConfiguration configuration = new CorsConfiguration();
